...
import com.vsnmobil.vbttnbatt.service.BluetoothLeService;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                displayData("** Checking battery. Please wait....\n\r");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.menu_power_off:
                mBluetoothLeService.power_off(mBluetoothLeService.bluetoothGattMap.get(mDeviceAddress));
                return true;
